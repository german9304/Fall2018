...
void Print_vector(double local_b[], int local_n, int n, char title[], 
      int my_rank, MPI_Comm comm);
void Print_vector_cyclic(double local_b[], int local_n, int n, char title[], 
      int my_rank, MPI_Comm comm);
...
#  endif
   ...
   Print_vector_cyclic(local_z, local_n, n, "The sum is", my_rank, comm);
